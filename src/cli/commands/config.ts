import { loadCredentials, getCredentialsPath } from "../../auth/credential-store.js";
...
export async function configCommand(): Promise<void> {
  ...
  // Runtime settings
  console.log("\n  Runtime:");
  console.log(`    AI Model:    ${process.env.PAW_AI_MODEL || "claude-sonnet-4-5-20250929 (default)"}`);
  console.log(`    Log Level:   ${process.env.PAW_LOG_LEVEL || "info (default)"}`);
  console.log(`    DB Path:     ${process.env.PAW_DB_PATH || "./data/paw.db (default)"}`);
