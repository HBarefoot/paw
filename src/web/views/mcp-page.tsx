			...
			{servers.length > 0 &&
				servers.map((server) => (
					<div class="card mb-md">
						...
						{server.error && <p class="text-error mb-md">{server.error}</p>}
			...
			<div class="card">
				...
				>
					...
					<div>
						<label>
							Command{" "}
							<span class="text-muted text-xs">(for stdio transport)</span>
						</label>
						<input
							type="text"
							name="command"
					...
					<div>
						<label>
							Arguments{" "}
							<span class="text-muted text-xs">(space-separated)</span>
						</label>
						<input
							type="text"
							name="args"
							placeholder="e.g. -y @modelcontextprotocol/server-filesystem /home/user"
							class="w-full"
						/>
					</div>
					<div>
						<label>
							URL{" "}
							<span class="text-muted text-xs">(for SSE/HTTP transport)</span>
						</label>
						<input
							type="text"
							name="url"
